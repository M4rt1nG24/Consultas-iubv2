...
if (!idUsuario || !rolUsuario) {
    ...
    if (nombreUsuario) {
        ...
        fetch(`https://4jdp777rcc.us-east-1.awsapprunner.com/estudiante/${idUsuario}`)
            .then(res => res.json())
            .then(data => {
...
function obtener_consultas_por_estudiante(id) {
    fetch(`https://4jdp777rcc.us-east-1.awsapprunner.com/consultas_estudiante/${id}`)
...
function abrirModalFirma(id_consulta) {
    ...
    document.getElementById("btnConfirmarFirma").onclick = () => {
        ...
        fetch(`https://4jdp777rcc.us-east-1.awsapprunner.com/firmar_consulta/${id_consulta}`, {
            method: "POST",
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    formSolicitud.addEventListener("submit", async (e) => {
        ...
        try {
            const res = await fetch("https://4jdp777rcc.us-east-1.awsapprunner.com/solicitar_consulta", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
...
async function cargarModulos() {
    try {
        const res = await fetch("https://4jdp777rcc.us-east-1.awsapprunner.com/modulos");
        const data = await res.json();
...
async function cargarDocentesSolicitud() {
    try {
        const res = await fetch("https://4jdp777rcc.us-east-1.awsapprunner.com/obtener_docentes");
        const data = await res.json();
...
function obtener_solicitudes_estudiante(id_estudiante) {
    fetch(`https://4jdp777rcc.us-east-1.awsapprunner.com/obtener_solicitudes_estudiante/${id_estudiante}`)
        .then(res => res.json())
        .then(data => {
            if (data.success) {
...
async function cargarDocentes() {
    try {
        const res = await fetch(`https://4jdp777rcc.us-east-1.awsapprunner.com/consultas_estudiante/${idUsuario}`);
        const data = await res.json();
